    ...
    messages = [
        {
            ...
            "content": [
                ...
                # {"type": "text", "text": "Please describe in detail red hat in the image. Use at least seven adjective words, including its type, color, texture, etc. Do not use full sentences."},
